...
<%
//This class is creating tables in db name as ospjsp
try{
	Connection con=ConnectionProvider.getCon();
	Statement st=con.createStatement();
	String q1="create table users(name varchar(100),email varchar(100)primary key,mobileNumber bigint, securityQuestion varchar(200),answer varchar(200),password varchar(100),adderss varchar(500),city varchar(100),state varchar(100),country varchar(100))";
